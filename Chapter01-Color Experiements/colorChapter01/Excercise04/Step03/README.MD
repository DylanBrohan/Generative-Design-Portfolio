...
In this section i created the shakeColors function, which randomly generates a group of colors depending on the range that has been set. this is used/intergrated into the interpolate of colors.
```js
'use strict';
