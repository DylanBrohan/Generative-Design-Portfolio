...
In this section of the excercise, I began by replicating 'Excercise08' as it has the main principles needed for this excercise, I began by creating the random grid using the modulos and mapping it to the canvas once that was complete i have successfully created the random grid the also has tile segmentation within it 
