...
In this final step of the Excercise i have  added the key pressed function to allow more interactivity with the piece. the function allows the user to save the canvas as an image or change the objects variables such as brightness, saturation.
...
//Kep pressed function to change the attributes of each variable
function keyPressed() {
