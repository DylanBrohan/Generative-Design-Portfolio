...
This final documentation shows the complete file, with the added saturation, brightness + random mapping values.
This excercise also illustrates the use of a center gradiant function, which works from the center of each object outwards with a different saturation + brightness.
